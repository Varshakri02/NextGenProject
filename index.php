            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">DocatDoor</h5>
                        <p class="animated bounceInUp" style="font-size:17px; font-weight:300; letter-spacing:1px; color:#fff; margin-top:10px; text-shadow: 1px 1px 4px rgba(0,0,0,0.5);">
                            Quality Healthcare, Right at Your Doorstep.<br>
                            <span style="font-size:14px; opacity:0.85;">Connecting Patients with Trusted Doctors — Anytime, Anywhere.</span>
                        </p>
                    </div>
                </div>
